      ...
      <div className="flex items-start justify-between flex-wrap gap-4">
        ...
        <div className="flex gap-3 flex-wrap">
          <div className="flex border-4 border-white/20">
            <button onClick={() => { setView('seller'); setActiveDealId(null); }} className={"px-4 py-2 font-black uppercase italic text-xs transition-all " + (view === 'seller' ? 'bg-brand-yellow text-black' : 'text-white/40 hover:text-white')}>Seller</button>
            <button onClick={() => { setView('buyer'); setActiveDealId(null); }} className={"px-4 py-2 font-black uppercase italic text-xs transition-all " + (view === 'buyer' ? 'bg-brand-cyan text-black' : 'text-white/40 hover:text-white')}>Buyer</button>
          </div>
          <div className="flex border-4 border-white/20">
