    ...
    <div className="space-y-6">
      ...
      <div className="flex items-start justify-between flex-wrap gap-4">
        ...
        <div className="flex border-4 border-white/20">
          <button onClick={() => { setView('tickled'); setSelectedDeal(null); }}
            className={"px-5 py-2 font-black uppercase italic text-xs transition-all " + (view === 'tickled' ? 'bg-brand-yellow text-black' : 'text-white/40 hover:text-white')}>
            SELLER
          </button>
          <button onClick={() => { setView('tickler'); setSelectedDeal(null); }}
            className={"px-5 py-2 font-black uppercase italic text-xs transition-all " + (view === 'tickler' ? 'bg-brand-cyan text-black' : 'text-white/40 hover:text-white')}>
            BUYER
          </button>
        </div>
      </div>
