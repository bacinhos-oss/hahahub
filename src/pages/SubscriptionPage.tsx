              ...
              <section className="space-y-10">
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {[
                      { label: 'Call Sheet — Actors', icon: 'person', subject: 'Call Sheet — [Show Title] — [Date]', body: 'Dear [Name],

This is your call sheet for [Show Title] on [Date] at [Venue].
...
Break a Leg! 🎭
[Producer]' },
                      { label: 'Tech Brief — Crew', icon: 'settings', subject: 'Tech Brief — [Show Title] — [Date]', body: 'Dear [Name],

Tech setup for [Show Title] on [Date] at [Venue].
...
See you there!
[Producer]' },
                      { label: 'Rights Inquiry Follow-up', icon: 'mail', subject: 'Following up — [Show Title] Rights Inquiry', body: 'Dear [Name],

I am following up on my inquiry about the rights for [Show Title].

I would love to discuss next steps at your earliest convenience.

Best regards,
[Producer]' },
                      { label: 'Deal Confirmation', icon: 'handshake', subject: 'Rights Agreement Confirmed — [Show Title]', body: 'Dear [Name],

Thank you for confirming the rights agreement for [Show Title].

Licensed for: [Territory]
Performances: [Number]
Royalty: [%]
