...
<tr><td style="background:#0a0a0a;padding:36px;">
  ...
  <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:16px;">
    <tr><td style="background:#111;border:2px solid rgba(255,255,255,0.1);padding:20px;">
      <p style="color:#FFDE03;font-size:9px;font-weight:900;text-transform:uppercase;letter-spacing:3px;margin:0 0 10px">What is HahaHub?</p>
      <p style="color:rgba(255,255,255,0.7);font-size:13px;line-height:1.7;margin:0 0 12px">The first marketplace for international comedy theatre rights. Buy and sell rights to comedy productions directly — no agents, no commission, producer to producer.</p>
      <p style="color:#fff;font-size:13px;font-weight:900;font-style:italic;margin:0 0 12px">That's HahaHub. The Laff Exchange.</p>
      <p style="color:#FF0266;font-size:11px;font-weight:900;text-transform:uppercase;letter-spacing:3px;font-style:italic;margin:0">Tickle. Set Up. Punch.</p>
    </td></tr>
  </table>
